        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TriggerName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false, comment: "触发器名称"),
                    TriggerGroup = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false, defaultValue: "DEFAULT", comment: "触发器分组"),
                    CronExpression = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false, comment: "Cron表达式"),
                    Description = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true, comment: "作业描述"),
                    JobType = table.Column<int>(type: "integer", nullable: false, comment: "作业类型"),
                    JobClassOrApi = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false, comment: "作业类名或API URL"),
                    JobData = table.Column<string>(type: "text", nullable: true, comment: "作业数据(JSON格式)"),
                    ApiMethod = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true, defaultValue: "GET", comment: "API请求方法"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NotificationId = table.Column<Guid>(type: "uuid", nullable: false, comment: "通知ID"),
                    Title = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false, comment: "通知标题"),
                    ...
                    ErrorMessage = table.Column<string>(type: "text", nullable: true, comment: "错误信息"),
                    TriggeredBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true, comment: "触发来源"),
                    CreateTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, comment: "创建时间"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SettingId = table.Column<Guid>(type: "uuid", nullable: false, comment: "设置ID"),
                    Key = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false, comment: "设置键"),
                    Value = table.Column<string>(type: "text", nullable: false, comment: "设置值"),
                    Description = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false, comment: "设置描述"),
                    Enabled = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true, comment: "是否启用"),
                    CreateTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, comment: "创建时间"),
                    UpdateTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true, comment: "更新时间")
                },
                constraints: table =>
