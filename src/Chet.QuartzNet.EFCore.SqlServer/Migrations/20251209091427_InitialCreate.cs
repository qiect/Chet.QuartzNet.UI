    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LogId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "日志ID"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NotificationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "通知ID"),
                    Title = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false, comment: "通知标题"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SettingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "设置ID"),
                    Key = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, comment: "设置键"),
